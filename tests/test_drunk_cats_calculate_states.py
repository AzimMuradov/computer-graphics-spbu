...
def test_single_cat(backend):
    ...
    states = backend.drunk_cats_calculate_states(1, positions, window_width, window_height, scale)
...
def test_two_cats_no_interactions(backend):
    ...
    states = backend.drunk_cats_calculate_states(2, positions, window_width, window_height, scale)
...
def test_three_cats_two_fight_one_hiss(backend):
    ...
    states = backend.drunk_cats_calculate_states(3, positions, window_width, window_height, scale)
...
def test_four_cats_all_fighting(backend):
    ...
    states = backend.drunk_cats_calculate_states(4, positions, window_width, window_height, scale)
